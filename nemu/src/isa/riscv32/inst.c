...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 001 ????? 11100 11", csrrw,   I, R(rd) = CSR(imm); CSR(imm) = src1;printf("csr: 0x%08x, addr: 0x%08x\n", imm, CSR(MTVEC)));
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall ,  N, s->dnpc = isa_raise_intr(CSR(MCAUSE), CSR(MEPC))); // ecall
