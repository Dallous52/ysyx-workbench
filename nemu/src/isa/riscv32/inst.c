...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh,   R, long long mh = (long long)SIGN(src1) * SIGN(src2); R(rd) = *(((uint32_t*)&mh) + 1));
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu,   R, uint64_t mh = (uint64_t)src1 * (uint64_t)src2; R(rd) = mh >> 32);
